import{f as _,a5 as u,e as a,g as t,t as o,a2 as c,F as f,al as h,A as g,o as s,af as v,d as x,j as b}from"../modules/vue-N3R6Ijpr.js";import{a as y,u as N}from"../index-CwtlA-xy.js";import{a as m}from"../monaco/bundled-types-BfFBD5oG.js";import{_ as k}from"./NoteDisplay.vue_vue_type_style_index_0_lang-DMLMkQof.js";import"../modules/shiki-DYk5HoGs.js";import"../modules/file-saver-C8QSpN-3.js";const w={id:"page-root"},L={class:"m-4"},T={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},H={class:"text-lg"},S={class:"font-bold flex gap-2"},j={class:"opacity-50"},A={key:0,class:"border-main mb-8"},W=_({__name:"print",setup(C){const{slides:d,total:p}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;

import{f as _,a4 as u,e as a,g as t,t as o,a1 as c,F as f,ak as h,z as g,o as s,ae as v,d as x,j as b}from"../modules/vue-B8wrMdGh.js";import{a as k,u as y}from"../index-Dnach77Y.js";import{a as m}from"../monaco/bundled-types-T98T9fgQ.js";import{_ as N}from"./NoteDisplay.vue_vue_type_style_index_0_lang-BfJSZeK6.js";import"../modules/shiki-DKS4g58z.js";import"../modules/file-saver-C8QSpN-3.js";const w={id:"page-root"},L={class:"m-4"},T={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},H={class:"text-lg"},S={class:"font-bold flex gap-2"},j={class:"opacity-50"},z={key:0,class:"border-main mb-8"},W=_({__name:"print",setup(C){const{slides:d,total:p}=k();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
